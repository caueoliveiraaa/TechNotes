# Youtube
---
## Phase 1 - (Algorithms + Challenges + Design and architecture)
```
...
```
## Phase 2 - (REST API + Bash + Data Analysis)
```
Data Analysis with Python: Part 1 of 6 (Live Course): https://www.youtube.com/watch?v=EsDFiZPljYo&list=PLWKjhJtqVAblvI1i46ScbKV2jH1gdL7VQ
...
Python Data Analysis and Visualization Course – Astronomical Data: https://www.youtube.com/watch?v=H9KefzbryEw&t=4481s
(Course) REST APIs with Flask and Python in 2024
Python for Data Science Course – Hands-on Projects with EDA, AB Testing & Business Intelligence: https://www.youtube.com/watch?v=FTpmwX94_Yo
...
Pandas & Python for Data Analysis by Example – Full Course for Beginners: https://www.youtube.com/watch?v=gtjxAH8uaP0&t=1s
Full HTTP Networking Course – Fetch and REST APIs in JavaScript: https://www.youtube.com/watch?v=2JYT5f2isg4
Bash Scripting Tutorial for Beginners: https://www.youtube.com/watch?v=tK9Oc6AEnR4
Build 12 Data Science Apps with Python and Streamlit - Full Course: https://www.youtube.com/watch?v=JwSS70SZdyM&t=7603s
Advanced Git Tutorial - Interactive Rebase, Cherry-Picking, Reflog, Submodules and more - https://www.youtube.com/watch?v=qsTthZi23VE
OpenCV Course - Full Tutorial with Python:  https://www.youtube.com/watch?v=oXlwWbU8l2o&t=7s    
Tutorial Git Para Profissionais: https://www.youtube.com/watch?v=Uszj_k0DGsg
R Programming Tutorial - Learn the Basics of Statistical Computing: https://www.youtube.com/watch?v=_V8eKsto3Ug&t=6015s
...
PyTorch for Deep Learning & Machine Learning – Full Course: https://www.youtube.com/watch?v=V_xro1bcAuA&t=36742s
